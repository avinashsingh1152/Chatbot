...
def add_ChatbotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBotData': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBotData,
...
class ChatbotService(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/chatbot.ChatbotService/SayHello',
    ...
    def GetBotData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/chatbot.ChatbotService/GetBotData',
